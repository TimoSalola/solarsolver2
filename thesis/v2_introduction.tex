...
%there is very little reason to use a model that would solve geolocation and panel angles without taking into account that some parameters are already known. 
